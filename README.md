# Template Laravel API Project Fan Content Hub With Frontend VUE (TYPESCRIPT)
...
```bash
git clone -b development-vue git@gitlab.com:fan-content-hub/template-laravel-vue-fan-content-hub.git
```

via https

```bash
git clone -b development-vue https://gitlab.com/fan-content-hub/template-laravel-vue-fan-content-hub.git
```
