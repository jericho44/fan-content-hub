<template>
    <ul class="vue-pagination-fan-content-hub">
    <li>
  ...
  <style scoped>
    .vue-pagination-fan-content-hub{
        display: flex;
        flex-wrap: wrap;
    ...
    .vue-pagination-fan-content-hub  button {
        padding: 10px;
    ...
    .vue-pagination-fan-content-hub  button.btn-prev-next-pagination {
        background: #F7F9FB !important;
        border-radius: 8px !important;
    }

    .vue-pagination-fan-content-hub button.active {
