<template>
    <div class="vue-select-single-fan-content-hub" ref="dropdownRef">
...
<style scoped>
.vue-select-single-fan-content-hub {
    position: relative;
    width: 100%;
    display: block;
}

.vue-select-single-fan-content-hub .select-single-box {
    display: flex;
    align-items: center;
...
.vue-select-single-fan-content-hub .select-single-option-search input {
    width: 100%;
    padding: 10px 0;
    margin-left: 10px;
    color: black;
...
.vue-select-single-fan-content-hub .select-single-option {
    position: absolute;
    width: 100%;
    z-index: 99999;
    background-color: #fff;
...
.vue-select-single-fan-content-hub .select-single-option-list {
    max-height: 200px;
    overflow: auto;
}

.vue-select-single-fan-content-hub .select-single-option-list a {
    color: black;
    padding: 10px;
    width: 100%;
    font-size: 1.1rem;
...
.vue-select-single-fan-content-hub .select-single-option-list a:hover,
.vue-select-single-fan-content-hub .select-single-option-list a.active {
    background-color: #f2f2f2 !important;
}

.vue-select-single-fan-content-hub .select-single-option-list a.disabled {
    cursor: no-drop;
    background-color: #fff !important;
}

.vue-select-single-fan-content-hub .select-single-option-list a.no-select {
    cursor: no-drop;
    background-color: #f2f2f2 !important;
}

.vue-select-single-fan-content-hub .select-single-remove-icon {
    margin-right: 5px;
}

.vue-select-single-fan-content-hub .select-single-remove-icon svg path {
    fill: black;
}

.vue-select-single-fan-content-hub .select-single-remove-icon:hover svg path {
    fill: red;
}
