<template>
    <div class="vue-file-upload-fan-content-hub">
...
<style scoped>
.vue-file-upload-fan-content-hub .file-upload-list-file {
    display: flex;
...
.vue-file-upload-fan-content-hub .file-upload-preview-file {
...
.vue-file-upload-fan-content-hub .remove-file-upload-button {
    position: absolute;
    border-radius: 100px;
    width: 20px;
    display: flex;
...
.vue-file-upload-fan-content-hub .file-upload-preview-name {
    font-size: 12px;
    white-space: nowrap;
    overflow: hidden;
...
.vue-file-upload-fan-content-hub .file-upload-preview-name:hover {
    overflow: unset !important;
}

.vue-file-upload-fan-content-hub .file-upload-preview-size {
    font-size: 16px;
    font-weight: 600;
}


.vue-file-upload-fan-content-hub .toast-file-upload {
    visibility: hidden;
    min-width: 250px;
...
.vue-file-upload-fan-content-hub .toast-file-upload.show {
    visibility: visible;
    opacity: 1;
}
