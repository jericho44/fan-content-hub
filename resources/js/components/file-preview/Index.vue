<template>
    <div class="vue-file-preview-fan-content-hub">
...
<style scoped>
.vue-file-preview-fan-content-hub {
    display: flex;
    justify-content: space-between;
    align-items: center;
}

.vue-file-preview-fan-content-hub .vue-file-preview-left {
    display: flex;
    align-items: flex-start;
}

.vue-file-preview-fan-content-hub .vue-file-preview-left img {
    margin-top: 5px;
}

.vue-file-preview-fan-content-hub .vue-file-preview-left .file-info-group {
    padding-left: 10px;
}

.vue-file-preview-fan-content-hub .vue-file-preview-left .file-info-group .file-name {
    font-size: 15px;
...
.vue-file-preview-fan-content-hub .vue-file-preview-left .file-info-group .file-size {
    color: #a1a5b7 !important;
    font-size: 14px !important;
}

.vue-file-preview-fan-content-hub .vue-file-preview-right svg path {
    fill: red;
}

.vue-file-preview-fan-content-hub .vue-file-preview-right .remove-button {
    padding: 0 !important;
...
.vue-file-preview-fan-content-hub .modal-overlay-file-preview {
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
.vue-file-preview-fan-content-hub .modal-content-file-preview {
...
/* Close button style */
.vue-file-preview-fan-content-hub .close-button-file-preview {
    position: absolute;
    top: 10px;
    right: 10px;
