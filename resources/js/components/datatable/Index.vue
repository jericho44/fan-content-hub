<template>
    <div class="vue-datatable-fan-content-hub">
...
.vue-datatable-fan-content-hub .datatable-header {
    display: flex;
    align-items: center;
...
.vue-datatable-fan-content-hub .datatable-body {
    width: 100%;
    overflow-x: auto;
}

.vue-datatable-fan-content-hub .datatable-header .datatable-left-header,
.vue-datatable-fan-content-hub .datatable-header .datatable-right-header {
    margin-bottom: 10px;
    display: flex;
    align-items: center;
}
...
.vue-datatable-fan-content-hub .select-show-per-page {
    display: block;
    width: 100%;
    padding: 7px 10px;
    font-size: 1rem;
...
.vue-datatable-fan-content-hub .search-data {
    display: block;
    padding: 5px 0;
    width: 100%;
    min-width: 180px;
...
.vue-datatable-fan-content-hub .loader {
...
.vue-datatable-fan-content-hub .datatable-footer {
    display: flex;
    margin-top: 15px;
    justify-content: space-between;
    align-items: center;
...
.vue-datatable-fan-content-hub .custom-vue-datatable-pagination {
    display: flex;
    flex-wrap: wrap;
...
.vue-datatable-fan-content-hub .custom-vue-datatable-pagination button {
    padding: 10px;
...
.vue-datatable-fan-content-hub .custom-vue-datatable-pagination button.btn-prev-next-datatable {
    background: #F7F9FB !important;
    border-radius: 8px !important;
}

.vue-datatable-fan-content-hub .custom-vue-datatable-pagination button.active {
    background: #0069B5 !important;
    border-radius: 8px;
    color: #fff !important;
}

.vue-datatable-fan-content-hub .custom-vue-datatable {
    width: 100%;
}

.vue-datatable-fan-content-hub .custom-vue-datatable thead tr th {
...
.vue-datatable-fan-content-hub .custom-vue-datatable tbody tr td {
    border-bottom: 1px #eaebed solid !important;
    padding: 15px 5px;
}
