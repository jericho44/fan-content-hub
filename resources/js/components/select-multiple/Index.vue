<template>
    <div class="vue-select-multiple-fan-content-hub" ref="dropdownRef">
...
<style scoped>
.vue-select-multiple-fan-content-hub {
    position: relative;
    width: 100%;
    display: block;
}

.vue-select-multiple-fan-content-hub .select-multiple-box {
    display: flex;
    align-items: center;
...
.vue-select-multiple-fan-content-hub .select-multiple-option-search input {
    width: 100%;
    padding: 10px 0;
    margin-left: 10px;
    color: black;
...
.vue-select-multiple-fan-content-hub .select-multiple-option {
    position: absolute;
    width: 100%;
    z-index: 99999;
    background-color: #fff;
...
.vue-select-multiple-fan-content-hub .select-multiple-option-list {
    max-height: 200px;
    overflow: auto;
}

.vue-select-multiple-fan-content-hub .select-multiple-option-list a {
    color: black;
    padding: 10px;
    width: 100%;
    font-size: 1.1rem;
...
.vue-select-multiple-fan-content-hub .select-multiple-option-list a:hover,
.vue-select-multiple-fan-content-hub .select-multiple-option-list a.active {
    background-color: #f2f2f2 !important;
}

.vue-select-multiple-fan-content-hub .select-multiple-option-list a.disabled {
    cursor: no-drop;
    background-color: #fff !important;
}

.vue-select-multiple-fan-content-hub .select-multiple-option-list a.no-select {
    cursor: no-drop;
    background-color: #f2f2f2 !important;
}

.vue-select-multiple-fan-content-hub .select-multiple-remove-icon {
    margin-right: 5px;
}

.vue-select-multiple-fan-content-hub .select-multiple-remove-icon svg path {
    fill: black;
}

.vue-select-multiple-fan-content-hub .select-multiple-remove-icon:hover svg path {
    fill: red;
}

.vue-select-multiple-fan-content-hub .select-multiple-selected-value-group {
    display: flex;
    flex-wrap: wrap;
}


.vue-select-multiple-fan-content-hub .select-multiple-selected-value-group svg path {
    fill: black;
}

.vue-select-multiple-fan-content-hub .select-multiple-selected-value-group svg:hover path {
    fill: red;
}
